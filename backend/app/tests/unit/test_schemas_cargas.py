...
def test_carga_schema_validar_contra_pedido_rechaza_fuera_de_ventana(valid_carga_dict, valid_pedido_dict):
    ...
    pedido = CreatePedidoSchema(**{**valid_pedido_dict, "fechaCarga": ahora + __import__("datetime").timedelta(days=1), "fechaDescarga": ahora + __import__("datetime").timedelta(days=2)})
